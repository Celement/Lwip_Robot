...
void Adc_Init(void)
{
	...
	//RCC_APB2PeriphResetCmd(RCC_APB2Periph_ADC1,ENABLE); //ADC1时钟复位
	//RCC_APB2PeriphResetCmd(RCC_APB2Periph_ADC1,DISABLE); //ADC1时钟复位结束
	...
	ADC_RegularChannelConfig(ADC1,ADC_Channel_5,1,ADC_SampleTime_480Cycles); //规则通道组设置 通道1  480个周期,提高采样时间可以提高精确度	
